...
frappe.ui.form.on("Roll", {
    refresh(frm) {
            ...
            if (appRole === false) {
                    cur_frm.fields_dict['roll_qualities'].grid.wrapper.find('.btn-open-row').hide();

                    $('*[data-fieldname="roll_qualities"]').find('.grid-add-row').hide();
            }
                    ...
                    frm.add_custom_button('Manual Entry', () => {
                        const d = new frappe.ui.Dialog({
                                ...
                                primary_action(values) {
                                    ...
                                    frm.call({
                                        method: 'pqis.anc.doctype.roll.roll.save_raw_data',
